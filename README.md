...
Lectura y explicación de documentos bancarios **100% en el dispositivo**, sin que ninguna imagen ni dato salga jamás del equipo. Construido para el **Decentralized AI Hackathon** (ISD × Tether/QVAC, septiembre 2026).
...
## Requisito técnico (art. 10 de las bases)
...
## Base preexistente utilizada (declaración obligatoria, art. 11.c)
